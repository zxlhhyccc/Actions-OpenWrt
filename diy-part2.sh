...
wget -P ./package/libs/wolfssl/patches/ https://github.com/zxlhhyccc/acc-imq-bbr/raw/master/master/package/libs/wolfssl/patches/400-devcrypto-remove-duplicate-definition-of-ret.patch
