...
wget -P ./feeds/luci/modules/luci-base/ https://github.com/zxlhhyccc/acc-imq-bbr/raw/master/master/feeds/luci/modules/luci-base/patches/001-initial-ucode-based-luci-runtime-ports.patch
pushd feeds/luci/modules/luci-base
patch -p1 < 001-initial-ucode-based-luci-runtime-ports.patch
rm -f 001-initial-ucode-based-luci-runtime-ports.patch
popd
