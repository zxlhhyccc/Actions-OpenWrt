...
rm -rf luci-app-homeproxy luci-app-3ginfo-lite luci-app-sms-tool-js luci-app-3cat luci-app-spotifyd luci-app-filebrowser-go luci-app-msd_lite && git clone --depth 1 https://github.com/immortalwrt/luci.git && cp -rf ./luci/applications/luci-app-homeproxy ./ && cp -rf ./luci/applications/luci-app-3ginfo-lite ./ && cp -rf ./luci/applications/luci-app-sms-tool-js ./ && cp -rf ./luci/applications/luci-app-3cat ./ && cp -rf ./luci/applications/luci-app-spotifyd ./ && cp -rf ./luci/applications/luci-app-filebrowser-go ./ && cp -rf ./luci/applications/luci-app-msd_lite ./ && rm -rf luci && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-homeproxy/Makefile && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-3ginfo-lite/Makefile && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-sms-tool-js/Makefile && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-3cat/Makefile && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-spotifyd/Makefile && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-filebrowser-go/Makefile && sed -i 's#include ../../luci.mk#include $(TOPDIR)/feeds/luci/luci.mk#g' luci-app-msd_lite/Makefile
